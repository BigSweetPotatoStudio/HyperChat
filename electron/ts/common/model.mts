      ...
      this.instance = await pipeline(
        ...
        this.model,
        {
          progress_callback: (p) => {
            ...
            progress_callback && progress_callback.apply(this, [p]);
          },
        }
      );
    }
...
let i = await BgeM3.getInstance();
// console.log("embeddings", await BgeM3.embedding("What is BGE M3?"));

// BGE-M3 输出 1024 维向量
// const schema: lancedb.SchemaLike = {
//   fields: {
//     id: "int",
//     text: "string",
//     category: "string",

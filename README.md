...
* Supports OpenAI-style LLMs such as `OpenAI`, `Claude`, `Claude(OpenAI)`, `Qwen`, `Deepseek`, `GLM`, `Ollama`, `xAI`, `Gemini`.
* Fully supports MCP.
...
- [x] Supports scheduled tasks, specifying Agents to complete tasks periodically, and viewing task completion status.
- [x] Supports `KaTeX`, displays mathematical formulas, code rendering adds highlights and quick copy
- [x] Added `RAG`, based on mcp knowledge base
- [x] Added ChatSpace concept, supports multi-conversation chatting
...
Install via the command line or refer to the official GitHub tutorial [uv](https://github.com/astral-sh/uv)
...
Install via the command line or download from the official site, [nodejs](https://nodejs.org/en)
```
# MacOS
brew install node
# windows
...
#### Support clicking tool names for direct invocation and debugging
...
#### Supports @ quick input + calling Agents
...
#### You can access it anywhere on any device via the web and set a password
...
#### Call terminal, compile and upgrade Nginx
...
#### What limited-time free games are available? Please visit the website and call tools
...
#### Using web tools + command line tools to open GitHub README for learning + GIT clone + build development foundation
...
* This project is for learning and communication purposes only. Any actions taken using this project, including but not limited to web scraping, are not the responsibility of the project's developers.
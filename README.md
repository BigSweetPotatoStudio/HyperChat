...
HyperChat is an open-source Chat client that supports MCP and allows the use of various LLM APIs for the best Chat experience, as well as productivity tools.
...
- [x] Supports defining Agents with preset prompts and selected allowed MCPs
- [x] Supports scheduled tasks, specifying Agents to complete tasks on time and view task completion status.
- [x] Supports `KaTeX` for displaying mathematical formulas, enhances code rendering with highlights and quick copy
- [x] Added `RAG` based on mcp knowledge base
- [x] Introduced ChatSpace concept to support multi-dialog concurrent chatting
...
Install via command line or view the official GitHub tutorial [uv](https://github.com/astral-sh/uv)
...
Install via command line or visit the official website to download, official site [nodejs](https://nodejs.org/en)
```
# MacOS
brew install node
# windows
...
#### Super input supporting variables (text + js code variables), basic syntax checking + Hover live preview
...
#### mcp calling Tool hints + dynamically modifying LLM calling Tool parameters
...
#### Calls terminal mcp to automatically analyze asar files + helps me unpack
...
#### By using web tools + command line tools, open GitHub README for learning + GIT clone + building a development foundation
...
* This project is for learning and communication purposes only. If you use this project for any operations, such as web crawling, the developers of this project are not responsible.
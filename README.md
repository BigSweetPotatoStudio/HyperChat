...
- [x] `MCP GateWay` gateway, merges multiple MCP tools into one MCP, supports `see`, `http`
...
- [x] Supports scheduled tasks, designates Agents to complete tasks on schedule and check task completion status.
...
- [x] Supports model comparison during chat
...
#### MCP GateWay gateway, merges multiple MCP tools into one MCP, exposed for external AI tools use.
...
#### Supports clicking tool name for direct debugging
...
#### Call terminal MCP to automatically analyze asar files + help me unzip
...
#### Helps you open web pages, analyze results, and write into files
![image](https://github.com/user-attachments/assets/a036dcf8-ffb4-4070-ac4f-a3b0533f66c2)

#### Through web tools + command line tools, open Github README for learning + GIT clone + build developer environment
![image](https://github.com/user-attachments/assets/fd0d737e-0eaa-4410-85e0-27fd45f0e5a5)

#### Multi-chat workspace + night mode
![image](https://github.com/user-attachments/assets/ca9d77d7-d023-431f-8359-6023ab3e338a)

#### Scheduled task list + send messages to Agent on schedule to complete tasks
...
* This project is for learning and communication purposes only. If you use this project for any actions, such as web scraping, it has no connection with the developers of this project.
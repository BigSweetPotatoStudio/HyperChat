...
HyperChat is an open-source chat client that supports MCP and can use various LLM APIs to provide the best chat experience. It also implements productivity tools.
...
- [x] `HyperPrompt` prompt syntax supports variables (text + js code variables), with basic syntax detection + hover real-time preview.
- [x] `MCP` extension
- [x] Supports dark mode 🌙
- [x] Resources, Prompts, Tools support
- [x] Supports English and Chinese
- [x] Supports rendering of `Artifacts`, `SVG`, `HTML`, `Mermaid`
- [x] Supports defining Agents, with preset prompts and selection of allowed MCPs
- [x] Supports scheduled tasks, specifying Agents to complete tasks at set times, as well as viewing task completion status.
- [x] Supports `KaTeX`, displaying mathematical formulas, code rendering with highlights and quick copy
- [x] Added `RAG`, based on MCP knowledge base
- [x] Introduced the concept of ChatSpace, supporting multiple conversations simultaneously
...
* 1. Configure APIKEY, ensure your LLM service is compatible with the OpenAI style.
...
#### Support clicking tool names for direct debugging
...
#### Supports selecting MCP + choosing some Tools
![image](https://github.com/user-attachments/assets/9a297608-90be-4960-a4f1-ae627965486b)

#### You can access from anywhere + any device through the web, and set a password
![image](https://github.com/user-attachments/assets/a9825e5b-da6d-4e0a-852f-177a3f6df992)

#### Call terminal MCP to automatically analyze ASAR files + help me unpack
...
#### What are the limited-time free games, please visit the website to call tools
...
#### Open Github README learning + GIT clone + set up development environment with web tools + command line tools

...
HyperChat is an open-source chat client that supports MCP and can utilize APIs from various LLMs to provide the best chat experience, as well as to implement productivity tools.
...
- [x] Supports scheduled tasks, specifying Agents to complete tasks on schedule, and checking task completion status.
...
- [x] Added ChatSpace concept, supports multi-dialog chatting
...
| deepseek | ⭐⭐⭐      | Multi-step function call will encounter issues       |

## Usage

* 1. Configure APIKEY, ensure your LLM service is compatible with OpenAI style.
* 2. Ensure that `uv + nodejs` and others are installed in your system.
...
Install via command line, or visit the official site to download it, official site [nodejs](https://nodejs.org/en)
```
# MacOS
brew install node
# windows
...
#### Chat allows model comparison selection
...
#### Using web tools + command line tools, open Github README to learn + GIT clone + set up developmental environment
...
#### Scheduled task list + sending scheduled messages to Agent to complete tasks
...
* This project is for educational communication purposes only. If you use this project for any actions, such as web scraping, etc., it has no relation to the developers of this project.
...
HyperChat is an open-source Chat client that supports MCP and can utilize the APIs of various LLMs to provide the best Chat experience, as well as productivity tools.
...
* Built-in MCP plugin marketplace, user-friendly MCP installation with configuration filling, one-click installation, and welcome to submit [HyperChatMCP](https://github.com/BigSweetPotatoStudio/HyperChatMCP).
* Also supports third-party MCP manual installation by filling in `command`, `args`, `env`.
...
- [x] Supports `Artifacts`, `SVG`, `HTML` rendering, JavaScript error capture, supports opening Chrome's console
...
- [x] Adds ChatSpace concept, supports simultaneous chatting across multiple dialogues
- [x] Supports Agent calling Agent through HyperAgent's MCP
- [x] Adds scheduled tasks, specifies Agents to complete tasks on schedule, and check task completion status.
...
| openai   | ⭐⭐⭐⭐ | Can also perfectly support multi-step function calls (gpt-4o-mini is also okay) |
...
#### Calls terminal MCP to automatically analyze ASAR files + helps me extract them
...
#### Helps you open the web page, analyze results, and write to file
![image](https://github.com/user-attachments/assets/a036dcf8-ffb4-4070-ac4f-a3b0533f66c2)


#### Using web tools + command line tools, opens GitHub README for learning + GIT cloning + setting up development golden
...
* This project is for educational and communication purposes only. If you use this project for any operations, such as crawling behavior, it has nothing to do with the developers of this project.
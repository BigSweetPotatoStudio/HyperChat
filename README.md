...
* Built-in MCP plugin market with user-friendly MCP installation and configuration, one-click installation, and welcome contributions to [HyperChatMCP](https://github.com/BigSweetPotatoStudio/HyperChatMCP).
...
- [x] Supports freely creating and designing `Agent`, with preset prompts and MCP functionality selection
...
- [x] Supports `KaTeX`, displaying mathematical formulas, code rendering with highlighting, and quick copying
- [x] Added `RAG`, based on MCP knowledge base
- [x] Added ChatSpace concept, supports multiple conversations chatting simultaneously
...
#### One-click webpage creation and published to (Cloudflare)

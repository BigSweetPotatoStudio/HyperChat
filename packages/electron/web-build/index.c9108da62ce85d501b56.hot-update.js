...
/* harmony export */   GPT_MODELS: () => (/* binding */ GPT_MODELS),
/* harmony export */   KNOWLEDGE_BASE: () => (/* binding */ KNOWLEDGE_BASE),
/* harmony export */   MCP_CONFIG: () => (/* binding */ MCP_CONFIG),
/* harmony export */   MCP_CONFIG_SYNC: () => (/* binding */ MCP_CONFIG_SYNC),
/* harmony export */   MCP_GateWay: () => (/* binding */ MCP_GateWay),
/* harmony export */   TEMP_FILE: () => (/* binding */ TEMP_FILE),
/* harmony export */   TaskList: () => (/* binding */ TaskList),
/* harmony export */   VarList: () => (/* binding */ VarList),
/* harmony export */   VarScopeList: () => (/* binding */ VarScopeList),
/* harmony export */   electronData: () => (/* binding */ electronData),
/* harmony export */   zodVar: () => (/* binding */ zodVar),
/* harmony export */   zodVarScope: () => (/* binding */ zodVarScope)
/* harmony export */ });
...
class Data {
     ...
     */
    override({ init, initSync, save, saveSync }) {
        init && (this.init = init);
...
const AppSetting = new Data("app_setting.json", {
...
const electronData = new Data("electronData.json", {
    // port: 0,
    password: "123456",
    // mcp_server_port: 0,
    version: "",
...
const ChatHistory = new Data("chat_history.json", {
    data: [],
}, {
    sync: true,
});
const Agents = new Data("gpts_list.json", {
    data: [],
});
const GPT_MODELS = new Data("gpt_models.json", {
    data: [],
});
class MCP_CONFIG_DATA extends Data {
    async save(sync = true) {
        if (sync) {
            let result = this.get();
...
const MCP_CONFIG = new MCP_CONFIG_DATA("mcp.json", {
    mcpServers: {},
}, {
    sync: false,
});
const MCP_CONFIG_SYNC = new Data("mcp_sync.json", {
    mcpServers: {},
}, {
    sync: true,
});
const ENV_CONFIG = new Data("env.json", {
    PATH: "",
}, {
    sync: false,
});
const TEMP_FILE = new Data("temp_file.json", {
    mcpExtensionDataJS: "",
}, {
    sync: false,
});
const KNOWLEDGE_BASE = new Data("knowledge_base.json", {
    dbList: [],
}, {
    sync: false,
});
const TaskList = new Data("tasklist.json", {
    data: [],
}, {
    sync: true,
});
const zodVar = zod__WEBPACK_IMPORTED_MODULE_1__.z.object({
    ...
    scope: zod__WEBPACK_IMPORTED_MODULE_1__.z.string(),
    variableStrategy: zod__WEBPACK_IMPORTED_MODULE_1__.z.enum(["lazy", "immediate"]),
    variableType: zod__WEBPACK_IMPORTED_MODULE_1__.z.enum(["string", "js", "webjs"]),
    code: zod__WEBPACK_IMPORTED_MODULE_1__.z.string().optional(),
    description: zod__WEBPACK_IMPORTED_MODULE_1__.z.string().optional(),
});
const zodVarScope = zod__WEBPACK_IMPORTED_MODULE_1__.z.object({
    key: zod__WEBPACK_IMPORTED_MODULE_1__.z.string(),
    name: zod__WEBPACK_IMPORTED_MODULE_1__.z.string(),
    type: zod__WEBPACK_IMPORTED_MODULE_1__.z.enum(["builtin", "custom"]),
});
const VarList = new Data("var.json", {
    data: [{
...
const VarScopeList = new Data("var_scope.json", {
    data: [{
            name: "var",
            key: (0,uuid__WEBPACK_IMPORTED_MODULE_0__["default"])(),
            type: "custom",
        }, {
            name: "quick",
            key: (0,uuid__WEBPACK_IMPORTED_MODULE_0__["default"])(),
...
const MCP_GateWay = new Data("mcp_gateway.json", {
    data: [],
}, {
    sync: true,
});
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_chat__WEBPACK_IMPORTED_MODULE_1__, _sessions__WEBPACK_IMPORTED_MODULE_4__]);
([_chat__WEBPACK_IMPORTED_MODULE_1__, _sessions__WEBPACK_IMPORTED_MODULE_4__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1c9dbae30c093cebfd03")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.c9108da62ce85d501b56.hot-update.js.map
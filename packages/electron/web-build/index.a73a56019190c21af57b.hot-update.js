...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_chat__WEBPACK_IMPORTED_MODULE_1__, _common_call__WEBPACK_IMPORTED_MODULE_2__, _sessions__WEBPACK_IMPORTED_MODULE_4__]);
([_chat__WEBPACK_IMPORTED_MODULE_1__, _common_call__WEBPACK_IMPORTED_MODULE_2__, _sessions__WEBPACK_IMPORTED_MODULE_4__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
/* harmony import */ var _common_sleep__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../common/sleep */ "./src/common/sleep.ts");
...
/* harmony import */ var _ant_design_icons__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ant-design/icons */ "./node_modules/@ant-design/icons/es/icons/SnippetsOutlined.js");
/* harmony import */ var _ant_design_icons__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ant-design/icons */ "./node_modules/@ant-design/icons/es/icons/ClearOutlined.js");
/* harmony import */ var _i18n__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../i18n */ "./src/i18n.ts");
/* harmony import */ var _xterm_addon_clipboard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @xterm/addon-clipboard */ "./node_modules/@xterm/addon-clipboard/lib/addon-clipboard.js");
/* harmony import */ var _xterm_addon_clipboard__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_xterm_addon_clipboard__WEBPACK_IMPORTED_MODULE_8__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_common_call__WEBPACK_IMPORTED_MODULE_2__]);
_common_call__WEBPACK_IMPORTED_MODULE_2__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
let URL_PRE = (0,_common_call__WEBPACK_IMPORTED_MODULE_2__.getURL_PRE)();
let lastSizes = {};
...
function Sessions({ setSessionCount = undefined }) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        async function OpenTerminal(terminalID) {
            ...
            refresh();
            await (0,_common_sleep__WEBPACK_IMPORTED_MODULE_6__.sleep)(500);
            ...
            const clipboardAddon = new _xterm_addon_clipboard__WEBPACK_IMPORTED_MODULE_8__.ClipboardAddon();
        ...
        setTimeout(async () => {
            let terminalIDs = await (0,_common_call__WEBPACK_IMPORTED_MODULE_2__.call)("GetTerminals", []);
            for (let id of terminalIDs) {
                await OpenTerminal(id);
            }
            if (terminalIDs.length == 0) {
                await (0,_common_call__WEBPACK_IMPORTED_MODULE_2__.call)("OpenTerminal", []);
            }
        }, 1000);
    }, []);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "my-tabs" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(antd__WEBPACK_IMPORTED_MODULE_9__["default"], { type: "editable-card", activeKey: data.current.activeKey, onChange: (key) => {
                data.current.activeKey = key;
                refresh();
                (0,_common_call__WEBPACK_IMPORTED_MODULE_2__.call)("ActiveAITerminal", [key]);
            ...
            onEdit: (targetKey, action) => {
                if (action === "add") {
                    (0,_common_call__WEBPACK_IMPORTED_MODULE_2__.call)("OpenTerminal", []);
                }
                else {
                    data.current.sessions = data.current.sessions.filter((x) => x.id != targetKey);
                    refresh();
                    (0,_common_call__WEBPACK_IMPORTED_MODULE_2__.call)("CloseTerminal", [targetKey]);
                }
            }, items: data.current.sessions.map((x) => {
                if (x.type == "terminal") {
                    return {
                        label: (0,_i18n__WEBPACK_IMPORTED_MODULE_7__.t) `Terminal` + "-" + x.id,
                        key: x.id,
                        closable: true,
                        children: (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(antd__WEBPACK_IMPORTED_MODULE_10__["default"], { menu: {
                                items: [
                                    {
                                        label: (0,_i18n__WEBPACK_IMPORTED_MODULE_7__.t) `Copy`,
                                        key: 'Copy',
                                    ...
                                    {
                                        label: (0,_i18n__WEBPACK_IMPORTED_MODULE_7__.t) `Parse`,
                                        key: 'Parse',
                                    ...
                                    {
                                        label: (0,_i18n__WEBPACK_IMPORTED_MODULE_7__.t) `Clear`,
                                        key: 'Clear',
                                        icon: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_13__["default"], null),
                                    },
                                ],
                                onClick: (e) => {
                                    if (e.key == "Copy") {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1301cff4a6df3f3f0270")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.a73a56019190c21af57b.hot-update.js.map